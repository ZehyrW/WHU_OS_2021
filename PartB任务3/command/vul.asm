...
00001000 <main>:
    ...
    1006:	e8 03 00 00 00       	call   100e <test>
    100b:	90                   	nop
    100c:	c9                   	leave  
    100d:	c3                   	ret    
...
0000100e <test>:
    ...
    1014:	c7 45 f0 98 18 00 00 	movl   $0x1898,-0x10(%ebp)
    101b:	c7 04 24 9e 18 00 00 	movl   $0x189e,(%esp)
    1022:	e8 37 00 00 00       	call   105e <printf>
    1027:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    102e:	81 45 f4 fa 00 00 00 	addl   $0xfa,-0xc(%ebp)
    1035:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1038:	89 44 24 04          	mov    %eax,0x4(%esp)
    103c:	c7 04 24 aa 18 00 00 	movl   $0x18aa,(%esp)
    1043:	e8 16 00 00 00       	call   105e <printf>
    1048:	90                   	nop
    1049:	c9                   	leave  
    104a:	c3                   	ret    
...
00001050 <_start>:
    ...
    1057:	50                   	push   %eax
    1058:	e8 9d 07 00 00       	call   17fa <exit>
    105d:	f4                   	hlt    
...
0000105e <printf>:
    ...
    10a4:	e8 09 07 00 00       	call   17b2 <write>
    ...
    10bb:	00 
    10bc:	c7 44 24 08 bd 18 00 	movl   $0x18bd,0x8(%esp)
    10c3:	00 
    10c4:	c7 44 24 04 bd 18 00 	movl   $0x18bd,0x4(%esp)
    10cb:	00 
    10cc:	c7 04 24 ca 18 00 00 	movl   $0x18ca,(%esp)
    10d3:	e8 94 06 00 00       	call   176c <assertion_failure>
...
000010dd <printl>:
    ...
    1114:	e8 71 07 00 00       	call   188a <printx>
...
000014b8 <send_recv>:
    ...
    14cb:	c7 44 24 08 b0 00 00 	movl   $0xb0,0x8(%esp)
    14d2:	00 
    ...
    150d:	e8 5e 03 00 00       	call   1870 <sendrec>
    ...
    1530:	e8 3b 03 00 00       	call   1870 <sendrec>
    ...
    1550:	e8 1b 03 00 00       	call   1870 <sendrec>
    ...
    1573:	00 
    1574:	c7 44 24 08 d4 18 00 	movl   $0x18d4,0x8(%esp)
    157b:	00 
    157c:	c7 44 24 04 d4 18 00 	movl   $0x18d4,0x4(%esp)
    1583:	00 
    1584:	c7 04 24 e0 18 00 00 	movl   $0x18e0,(%esp)
    158b:	e8 dc 01 00 00       	call   176c <assertion_failure>
...
000016df <strjin>:
    ...
    16e2:	83 ec 14             	sub    $0x14,%esp
    16e5:	8b 45 10             	mov    0x10(%ebp),%eax
    16e8:	88 45 ec             	mov    %al,-0x14(%ebp)
    16eb:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    16ef:	74 06                	je     16f7 <strjin+0x18>
    16f1:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    16f5:	75 07                	jne    16fe <strjin+0x1f>
    16f7:	b8 00 00 00 00       	mov    $0x0,%eax
    16fc:	eb 51                	jmp    174f <strjin+0x70>
    16fe:	8b 45 08             	mov    0x8(%ebp),%eax
    1701:	89 45 fc             	mov    %eax,-0x4(%ebp)
    1704:	eb 04                	jmp    170a <strjin+0x2b>
    1706:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
    170a:	8b 45 fc             	mov    -0x4(%ebp),%eax
    170d:	0f b6 00             	movzbl (%eax),%eax
    1710:	84 c0                	test   %al,%al
    1712:	75 f2                	jne    1706 <strjin+0x27>
    1714:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1717:	0f b6 55 ec          	movzbl -0x14(%ebp),%edx
    171b:	88 10                	mov    %dl,(%eax)
    171d:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
    1721:	8b 45 0c             	mov    0xc(%ebp),%eax
    1724:	89 45 f8             	mov    %eax,-0x8(%ebp)
    1727:	eb 13                	jmp    173c <strjin+0x5d>
    1729:	8b 45 f8             	mov    -0x8(%ebp),%eax
    172c:	0f b6 10             	movzbl (%eax),%edx
    172f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1732:	88 10                	mov    %dl,(%eax)
    1734:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
    1738:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
    173c:	8b 45 f8             	mov    -0x8(%ebp),%eax
    173f:	0f b6 00             	movzbl (%eax),%eax
    1742:	84 c0                	test   %al,%al
    1744:	75 e3                	jne    1729 <strjin+0x4a>
    1746:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1749:	c6 00 00             	movb   $0x0,(%eax)
...
00001751 <spin>:
    ...
    175e:	c7 04 24 22 19 00 00 	movl   $0x1922,(%esp)
    1765:	e8 73 f9 ff ff       	call   10dd <printl>
    176a:	eb fe                	jmp    176a <spin+0x19>

0000176c <assertion_failure>:
    176c:	55                   	push   %ebp
    176d:	89 e5                	mov    %esp,%ebp
    176f:	83 ec 28             	sub    $0x28,%esp
    1772:	8b 45 14             	mov    0x14(%ebp),%eax
    1775:	89 44 24 14          	mov    %eax,0x14(%esp)
    1779:	8b 45 10             	mov    0x10(%ebp),%eax
    177c:	89 44 24 10          	mov    %eax,0x10(%esp)
    1780:	8b 45 0c             	mov    0xc(%ebp),%eax
    1783:	89 44 24 0c          	mov    %eax,0xc(%esp)
    1787:	8b 45 08             	mov    0x8(%ebp),%eax
    178a:	89 44 24 08          	mov    %eax,0x8(%esp)
    178e:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
    1795:	00 
    1796:	c7 04 24 38 19 00 00 	movl   $0x1938,(%esp)
    179d:	e8 3b f9 ff ff       	call   10dd <printl>
    17a2:	c7 04 24 6d 19 00 00 	movl   $0x196d,(%esp)
    17a9:	e8 a3 ff ff ff       	call   1751 <spin>
    17ae:	0f 0b                	ud2    
    17b0:	c9                   	leave  
    17b1:	c3                   	ret    
...
000017b2 <write>:
    ...
    17b5:	81 ec c8 00 00 00    	sub    $0xc8,%esp
    17bb:	c7 85 4c ff ff ff 09 	movl   $0x9,-0xb4(%ebp)
    17c2:	00 00 00 
    17c5:	8b 45 08             	mov    0x8(%ebp),%eax
    17c8:	89 45 d0             	mov    %eax,-0x30(%ebp)
    17cb:	8b 45 0c             	mov    0xc(%ebp),%eax
    17ce:	89 45 f4             	mov    %eax,-0xc(%ebp)
    17d1:	8b 45 10             	mov    0x10(%ebp),%eax
    17d4:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    17d7:	8d 85 48 ff ff ff    	lea    -0xb8(%ebp),%eax
    17dd:	89 44 24 08          	mov    %eax,0x8(%esp)
    17e1:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
    17e8:	00 
    17e9:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
    17f0:	e8 c3 fc ff ff       	call   14b8 <send_recv>
    17f5:	8b 45 d4             	mov    -0x2c(%ebp),%eax
    17f8:	c9                   	leave  
    17f9:	c3                   	ret    
...
000017fa <exit>:
    ...
    17fd:	81 ec c8 00 00 00    	sub    $0xc8,%esp
    1803:	c7 85 4c ff ff ff 12 	movl   $0x12,-0xb4(%ebp)
    180a:	00 00 00 
    180d:	8b 45 08             	mov    0x8(%ebp),%eax
    1810:	89 45 d0             	mov    %eax,-0x30(%ebp)
    1813:	8d 85 48 ff ff ff    	lea    -0xb8(%ebp),%eax
    1819:	89 44 24 08          	mov    %eax,0x8(%esp)
    181d:	c7 44 24 04 04 00 00 	movl   $0x4,0x4(%esp)
    1824:	00 
    1825:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
    182c:	e8 87 fc ff ff       	call   14b8 <send_recv>
    1831:	8b 85 4c ff ff ff    	mov    -0xb4(%ebp),%eax
    1837:	83 f8 13             	cmp    $0x13,%eax
    183a:	74 24                	je     1860 <exit+0x66>
    183c:	c7 44 24 0c 26 00 00 	movl   $0x26,0xc(%esp)
    1843:	00 
    1844:	c7 44 24 08 81 19 00 	movl   $0x1981,0x8(%esp)
    184b:	00 
    184c:	c7 44 24 04 81 19 00 	movl   $0x1981,0x4(%esp)
    1853:	00 
    1854:	c7 04 24 8c 19 00 00 	movl   $0x198c,(%esp)
    185b:	e8 0c ff ff ff       	call   176c <assertion_failure>
    1860:	c9                   	leave  
    1861:	c3                   	ret    
    1862:	66 90                	xchg   %ax,%ax
...
00001870 <sendrec>:
    ...
    1871:	51                   	push   %ecx
    1872:	52                   	push   %edx
    1873:	b8 01 00 00 00       	mov    $0x1,%eax
    1878:	8b 5c 24 10          	mov    0x10(%esp),%ebx
    187c:	8b 4c 24 14          	mov    0x14(%esp),%ecx
    1880:	8b 54 24 18          	mov    0x18(%esp),%edx
    1884:	cd 90                	int    $0x90
    1886:	5a                   	pop    %edx
    1887:	59                   	pop    %ecx
    1888:	5b                   	pop    %ebx
...
0000188a <printx>:
    ...
    1890:	8b 54 24 08          	mov    0x8(%esp),%edx
    1894:	cd 90                	int    $0x90
    1896:	5a                   	pop    %edx
    1897:	c3                   	ret    
